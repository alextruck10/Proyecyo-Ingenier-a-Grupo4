...
public class controlAnadirJugador {
	...
	public void AnadirJugador() throws IOException
	{
		...
		active=false;	
         ...
         try
         {
         DataOutputStream fout = new DataOutputStream(new BufferedOutputStream (new FileOutputStream("src/files/jugadores/"+userId+".jsonl")));
         fout.writeChars("{\"userId\":\""+userId+"\",\"email\":\""+email+"\",\"password\":\""+password+"\",\"userType\":\"jugador\",\"name\":\""+name+"\",\"lastnames\":\""+lastnames+"\",\"birthday\":\""+birthday+"\",\"genre\":\""+genre+"\",\"active\":"+active+"}");
         fout.close();
         }
         catch (Exception e)
         {
         ...
         BufferedWriter writer = new BufferedWriter(fw);) {
        	writer.write("\n");
           writer.write("{\"userId\":\""+userId+"\",\"email\":\""+email+"\",\"password\":\""+password+"\",\"userType\":\"jugador\"}");
         }  
